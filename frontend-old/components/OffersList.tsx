...
export function OffersList({ offers, onUpdate }: OffersListProps) {
  ...
  const handleSelectAll = () => {
    if (selectedOffers.size === offers.length) {
      ...
      setSelectedOffers(new Set(offers.map(o => o._id)))
    }
  }
        ...
        <div className="bg-white rounded-xl border-2 border-gray-100 p-4 flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            <button
              ...
              title={selectedOffers.size === offers.length ? 'Desselecionar todas' : 'Selecionar todas'}
            >
              ...
              <span className="font-medium text-gray-700">
                {selectedOffers.size === offers.length ? 'Desselecionar Todas' : 'Selecionar Todas'}
              </span>
            </button>
          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="flex items-start">
              <button
                ...
                title={selectedOffers.has(offer._id) ? 'Desselecionar' : 'Selecionar'}
              >
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                >
                  <Trash2 className="w-4 h-4" />
                  <span>{deleting === offer._id ? 'Excluindo...' : 'Excluir'}</span>
                </button>
              </div>
            </div>
          </div>
